                ...
                <div class="max-w-full mx-auto mt-5 bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <form action="{{ route('posts.store') }}" method="post" class="space-y-6" enctype="multipart/form-data">
                        ...
                        <div class="px-4">
                            ...
                            <input type="text" name="p_title" maxlength="100" id="p_title" value="{{ old('p_title') }}" required placeholder="Name your day!" class="w-full px-4 py-3 rounded-2xl border border-gray-300 focus:ring-4 focus:ring-blue-100 focus:border-blue-400 transition outline-none">
                        ...
                        <div class="px-4">
                            ...
                            <textarea
                                ...
                                class="w-full pl-8 pr-4 pt-1 pb-3 rounded-2xl border border-gray-300 focus:ring-4 focus:ring-blue-100 focus:border-blue-400 transition outline-none resize-none text-gray-700 leading-8"
                                style="
                                    background-image:linear-gradient(to bottom, transparent 31px, #dbe4f0 32px);
                                    background-size: 100% 32px;
                                    background-attachment: local;
                                ">{{ old('p_content') }}</textarea>
