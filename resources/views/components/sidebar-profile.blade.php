<div class="bg-white rounded-[1rem] shadow-sm border border-gray-100 p-6">
  ...
  <a href="#" class="block w-full border border-gray-400 hover:bg-[#B178CC] hover:text-white text-center font-bold py-4 mt-4 rounded-[1rem] shadow-md transition-transform hover:scale-[1.02] active:scale-95">
