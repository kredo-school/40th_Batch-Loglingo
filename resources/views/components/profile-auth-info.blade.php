...
<div class="grid grid-cols-1 md:grid-cols-[auto_1fr_auto] gap-x-8 gap-y-6 items-center md:items-start text-center md:text-left">
    ...
    <div class="flex flex-col items-center gap-4">       
        ...
        <div class="mt-2">
            ...
            class="flex items-center gap-2 px-3 py-1.5 text-xs border border-gray-400 rounded-xl text-gray-600 hover:bg-gray-600 hover:text-white transition whitespace-nowrap">
    ...
    <div class="flex flex-col items-center md:items-end gap-3 w-full mx-auto md:mr-0">
        ...
        <div class="flex items-end justify-center md:justify-end gap-0 -mt-7">
            ...
            <div class="relative bg-white rounded-xl border border-gray-300 px-3 py-2 min-h-[60px] max-w-[260px]">
                ...
                <!-- triangle -->
                <span class="absolute top-1/2 -right-2 -translate-y-1/2 w-0 h-0 border-t-8 border-b-8 border-l-8 border-t-transparent border-b-transparent border-l-gray-300"></span>

                <span class="absolute top-1/2 -right-[6px] -translate-y-1/2 w-0 h-0 border-t-6 border-b-6 border-l-6 border-t-transparent border-b-transparent border-l-white"></span>
                ...
                <div class="text-[11px] text-gray-700 space-y-0.5 text-left leading-tight whitespace-nowrap">
                    ...
                    @if($todayDone)
                        ...
                        @else
                        <p class="text-orange-500 text-[11px] animate-pulse underline">
