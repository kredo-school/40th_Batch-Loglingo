                                ...
                                <div @click.away="showViewModal = false"
                                    ...
                                    <div class="p-8 overflow-y-auto custom-scrollbar">
                                        ...
                                        <div class="bg-white rounded-[1rem] shadow-sm border border-gray-100 p-8 mb-6 relative">
                                            ...
                                            {{-- Question Report Count (rigt top) --}}
                                            ...
                                            <div class="flex items-start space-x-4 w-full mb-4 mt-2">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    {{-- question title --}}
                                                    <h2 class="text-[22px] font-extrabold text-gray-900 mb-2 leading-tight break-all">{{ $question->q_title }}</h2>
                                                    ...
                                                    <div class="flex items-center space-x-4 text-[13px] text-gray-400 mb-3">
                                                        ...
                                                        <div class="flex items-center space-x-4 text-[13px] text-gray-400">
                                                            <span><i class="fa-regular fa-clock mr-1"></i>Posted: {{ $question->created_at->diffForHumans() }}</span>
                                                        </div>
                                            ...
                                            <div class="mt-4 flex justify-end">
                                                <a href="{{ route('questions.show', $question->id) }}" class="text-xs text-[#B178CC] font-bold hover:underline">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="bg-white rounded-[1rem] shadow-sm border border-gray-100 p-6 flex items-start space-x-4 mx-4 relative">
                                                ...
                                                <img src="{{ $answer->user->avatar }}" alt="user" class="w-12 h-12 rounded-full object-cover">
                                                @else
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="text-gray-600 text-sm leading-relaxed break-all whitespace-pre-wrap">{!! nl2br(e($answer->a_content)) !!}
                                                    </div>
