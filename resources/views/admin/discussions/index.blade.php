                                    ...
                                    <div class="p-8 overflow-y-auto custom-scrollbar">
                                        ...
                                        <div class="bg-white rounded-[1rem] shadow-sm border border-gray-100 p-8 mb-6 relative">
                                            ...
                                            <div class="flex items-start space-x-4 w-full mb-4 mt-2">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    {{-- discussion title --}}
                                                    <h2 class="text-[22px] font-extrabold text-gray-900 mb-2 leading-tight break-all">{{ $discussion->d_title }}</h2>

                                                    {{-- discussion footer --}}
                                                    <div class="flex items-center space-x-4 text-[13px] text-gray-400 mb-3">
                                                        <span><i class="fa-regular fa-clock mr-1"></i>Posted: {{ $discussion->created_at->diffForHumans() }}</span>
                                            ...
                                            <div class="mt-4 flex justify-end">
                                                <a href="{{ route('discussions.show', $discussion->id) }}" class="text-xs text-[#B178CC] font-bold hover:underline">
                                                    View full discussion page <i class="fa-solid fa-arrow-right ml-1"></i>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-y-4">
                                            <h4 class="px-4 font-bold text-gray-500 text-sm uppercase tracking-widest flex items-center">
                                                <i class="fa-solid fa-comments mr-2"></i> Community Replies({{ $discussion->replies->count() }})
                                            </h4>
                                            ...
                                            <div class="bg-white rounded-[1rem] shadow-sm border border-gray-100 p-6 flex items-start space-x-4 mx-4 relative">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="text-gray-600 text-sm leading-relaxed break-all whitespace-pre-wrap">{!! nl2br(e($reply->r_content)) !!}
                                                    </div>
